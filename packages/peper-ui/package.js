Package.describe({
    ...
    version: '0.1.7',
    summary: 'Meteor Vue Framework for Google Material Design UI. ',
    git: 'https://github.com/DevsignStudio/peper/tree/master/packages/peper-ui',
...
Package.onUse(function(api) {
    ...
    api.use('ecmascript');
    api.use(['jquery', 'akryum:vue@1.0.2', 'akryum:vue-component@0.3.8',
        'akryum:vue-router2@0.0.1'
    ], 'client');
    api.mainModule('peper-client.js', 'client');
    api.addFiles(['client/css/materialdesignicons.css',
        'client/css/peper.css',
        'plugin/optiscroll/optiscroll.css'
    ], 'client');
